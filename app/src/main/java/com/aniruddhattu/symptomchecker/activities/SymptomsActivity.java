...
public class SymptomsActivity extends AppCompatActivity {
    ...
    private void getSymptoms() {
        symptomsList = new ArrayList<>();
        showProgressBar();
        String url = "https://schecker.azurewebsites.net/api/getSymptoms/NotExistingIDs";
        ...
        selectionTracker.addObserver(new SelectionTracker.SelectionObserver() {
            ...
            public void onSelectionChanged() {
                ...
                if (selectionTracker.hasSelection() && actionMode == null) {
                    actionMode = startSupportActionMode(new ActionModeController(SymptomsActivity.this, selectionTracker));
                    //DO SOMETHING HERE
    ...
    public void nextStep(View view) {
        Intent i = new Intent(SymptomsActivity.this, MoreSymptomsActivity.class);
    ...
    private boolean validateSymptom() {
        ...
        if (additionalSymptom.isEmpty()) {
            Toast.makeText(SymptomsActivity.this, R.string.error_symptom_empty, Toast.LENGTH_LONG).show();
            return false;
        } else {
            if (HelperFunctions.containsDigit(additionalSymptom)) {
                Toast.makeText(SymptomsActivity.this, R.string.error_symptom_contains_numbers, Toast.LENGTH_LONG).show();
                return false;
            }
        }
        return true;
